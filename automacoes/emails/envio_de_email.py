...
email_senha = open('passwords', 'r').read()
email_origem = 'campiaocaio@gmail.com' #se alterar o email origem, é necessário alterar também a senha no arquivo "mail_password"
email_destino = ('cvcampiaogmail.com')
